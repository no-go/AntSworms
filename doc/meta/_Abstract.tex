...
proteins. We are thinking ahead: these molecular machines should work as a robot
swarm in the future. Therefore we need a simple logic for each machine without
traditionally wireless network communication.
...
\begin{IEEEkeywords}
multi-robot systems, simulation, pheromones, insects, molecular machines
\end{IEEEkeywords}
